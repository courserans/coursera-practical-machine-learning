...
The data set records the accelerometer data for 6 participants who were asked to perform one set of 10 repetitions of the Unilateral Dumbbell Biceps Curl in five different manner. This is the "classe" variable in the training set.
...
(Source : http://groupware.les.inf.puc-rio.br/har#ixzz3UqHfAAqq)

The goal of this project t is to predict the manner in which a user did the exercise(classe) for a given test set. 
